...
- reusable governed-runtime helpers consumed from the transitional `govengine>=0.11.0a0,<0.13` range;
- contract lifecycle schemas, validators, and hash-chain verification consumed from `sclite-core>=0.8.0a0,<0.9`.
...
- public Ravenclaw consumes the transitional package ranges: `govengine>=0.11.0a0,<0.13` and `sclite-core>=0.8.0a0,<0.9`;
