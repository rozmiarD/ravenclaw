...
- Added a mechanically validated Ravenclaw -> GovEngine extraction-readiness roadmap, classifying already-covered projection adapters, deferred cross-profile contract candidates, and Ravenclaw-owned runtime implementation boundaries.
- Aligned install and threat-model dependency truth with the GovEngine alpha package line and made public truth validation guard those docs.
...
## 0.16.0 / 2026-05-20
- Prepared the narrow Ravenclaw package boundary for PyPI publication, exposing public security-profile and OpenClaw readiness helper APIs while keeping the full runtime, demo, Logdash, and validation fixtures source/reference-owned.
