...
VALIDATION_SURFACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        'title': 'Current lifecycle/review-bundle proof path',
        ...
        'claim': 'Builds the active Ravenclaw scoped-ticket lifecycle and validates its canonical SCLite current lifecycle/review bundle.',
