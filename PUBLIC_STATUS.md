...
- GovEngine's `security_profile_helpers` action/tooling and policy/scope modules remain upstream compatibility surfaces for the published dependency line, not Ravenclaw runtime authority
