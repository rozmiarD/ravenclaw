...
REPORTS_DIR = Path(os.getenv("RAVENCLAW_REPORTS_DIR") or str(WORKSPACE / "reports")).expanduser().resolve()
REPORTS_STATE_DIR = REPORTS_DIR / "state"
REPORTS_CACHE_DIR = REPORTS_DIR / "cache"
TMP_DIR = Path(os.getenv("RAVENCLAW_TMP_DIR") or str(WORKSPACE / "tmp")).expanduser().resolve()
