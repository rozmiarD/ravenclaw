...
from policy_core import get_runtime_allowed_tools, contains_banned_patterns, contains_tool_restricted_patterns, normalize_tool, check_credentials_policy  # type: ignore
...
def normalize_policy_decision_v0(
    ...
    *,
    ...
    """Return a richer v0.1 policy-decision shape without changing legacy callers."""
