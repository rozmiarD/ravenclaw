...
APPROVED_SPEC_BLOCKED_TOOLS = {
    "bash", "sh", "python", "python3", "perl", "ruby", "node", "php", "lua", "busybox"
}
APPROVED_SPEC_BLOCKED_CATEGORIES = {"operator_support"}
APPROVED_SPEC_BLOCKED_CAPABILITIES = {"operator_shell"}
