...
def test_security_profile_manifest_is_json_safe_and_current() -> None:
    ...
    assert manifest['package_chain']['ravenclaw'] == '0.18.2'
    assert manifest['package_chain']['govengine'] == '>=0.12.1a1,<0.13'
    assert manifest['package_chain']['sclite-core'] == '>=0.8.0b2,<0.9'
